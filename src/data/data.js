...
export const projectsData = [
  {
    ...
    description:
      "HRX is a SAAS-based software. It has 2 parts, one is B2B and the other is B2C. B2B is appraisal management software (This is my first project for MAAC). This software is used by several companies.  On the other hand, B2C is CV scrolling software, it can find out whether a CV is ATS friendly or not. this software is currently under development.",
    liveLink: "https://hrxbd.org",
  },
  {
    id: 2,
    name: "Bandenia",
    ...
    description:
      "Bandenia is a loan servicing company in Dubai. This is my latest project for MAAC. There are 4 portals in this project. I have worked with 3 portals (Admin, CRM, and Broker).",
    liveLink: "https://mortgagebcmb.com",
  },
  {
    id: 2,
    name: "Banglalink ennovators 7.0",
    technologies: [
      "ReactJS",
      "TypeScript",
      "Redux-Toolkit",
    ...
    description: "A project for Banglalink",
    liveLink: "https://banglalinkennovators.com",
  },
  {
    id: 3,
    name: "Smart Shopping",
